...
- **Solidity version pinned**: Changed from floating `^0.8.23` to exact `0.8.28`.
...
All contracts changed from `pragma solidity ^0.8.23` (floating) to `pragma solidity 0.8.28` (pinned). This means v6 can only compile with Solidity 0.8.28 exactly.
...
| v5 | v6 | Change Type |
|---|---|---|
| `pragma solidity ^0.8.23` | `pragma solidity 0.8.28` | Pinned compiler version |
